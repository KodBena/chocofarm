...
int main(int argc, char** argv) {
    ...
    // interleaved replicates (direct, pooled, fibered) ×3 — robust-benchmark-statistics
    double rd[3], rp[3], rf[3];
    for (int k = 0; k < 3; ++k) {
    ...
    std::printf("ALL-IN (fresh-direct):           %.2f us = %.2f ns/leaf = %.3f%% of producer per-leaf CPU\n",
