"""
tools/analysis/OpenTURNS/benchmarks/bench_lockfree_mpsc_wakeup.py
================================================================
...
def run(trials: int = 20000) -> dict[str, Any]:
    """Measure the hybrid spin-phase wakeup latency and LOG it. TIMING-SENSITIVE — operator-invoked, pinned
