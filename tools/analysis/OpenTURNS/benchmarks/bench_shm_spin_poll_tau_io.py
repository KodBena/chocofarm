"""
tools/analysis/OpenTURNS/benchmarks/bench_shm_spin_poll_tau_io.py
================================================================
...
def measure(n_msgs: int = 8, rows_per_msg: int = 32, cycles: int = 5000) -> dict[str, Any]:
    """Measure shm_spin_poll tau_io: time ONE drain+reply cycle over `n_msgs` coalesced producer messages of
