...
def measure(iters: int = 200000) -> "_est.Estimate":
    """Measure shm_spin_poll_tmsg_us_leaf (time the per-leaf ring memcpy in windows) and return its harmonized
...
def run(iters: int = 200000) -> dict[str, Any]:
    """Measure shm_spin_poll_tmsg_us_leaf and LOG it as a harmonized k=1 SHRINKABLE median Estimate
