"""
tools/analysis/OpenTURNS/untrusted_drive.py
===========================================
...
Run (sole-workload):
    /home/bork/w/vdc/venvs/generic/bin/python tools/analysis/OpenTURNS/untrusted_drive.py [slug]
...
def main() -> int:
    ...
    measurers = {i: _make_measurer(model.INPUT_QUANTITIES[nm][0], iters_cap) for i, nm in enumerate(names)}
