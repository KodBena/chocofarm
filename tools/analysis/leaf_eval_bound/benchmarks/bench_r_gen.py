"""
tools/analysis/leaf_eval_bound/benchmarks/bench_r_gen.py
==================================================
...
NAME = "R_gen"
MODULE_PATH = "leaf_eval_bound.benchmarks.bench_r_gen"
...
# The repo root (this file is tools/analysis/leaf_eval_bound/benchmarks/bench_r_gen.py -> up 4:
...
# resolves from ANY caller CWD. Without this the bench SIGABRTs from e.g. tools/analysis/leaf_eval_bound/.
...
# decisions/s/core pool as raw PROVENANCE (the variance authority is estimate.cov — §5.2 de-dup).
_B = _scaffold(
    name=NAME, quantity="producer_decisions_per_core", module_path=MODULE_PATH, description=_DESC,
    ...
    run_log=lambda res, log, **kw: log(res["per_rep_dps"], sample_size=1),
)
